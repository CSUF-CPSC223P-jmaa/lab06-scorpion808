...
def balanced(m):
    ...
    left_value = length(left_arm) * total_weight(end(left_arm))
    right_value = length(right_arm) * total_weight(end(right_arm))
    return left_value == right_value and balanced(end(left_arm)) and balanced(end(right_arm))
...
def check_par():
    ...
    True
    """
    r1 = interval(4, 7)  # Replace this line!
    r2 = interval(4, 7)  # Replace this line!
    return r1, r2
